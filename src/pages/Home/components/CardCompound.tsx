...
const Content = ({ content }: { content: string }) => {
	return <pre className="max-w-200 break-all text-base font-medium text-black">{content}</pre>;
};
